...
def _get_routes_from_kml(fname: str, destination: str, mode: str = 'walking', region: str = 'uk',
                         departure_time: datetime = None, arrival_time: datetime = None) -> list[list[list[str]]]:
    """
    ...
    # Get routes
    routes = [client.directions(origin=origin, destination=destination, mode=mode, region=region, alternatives=True,
